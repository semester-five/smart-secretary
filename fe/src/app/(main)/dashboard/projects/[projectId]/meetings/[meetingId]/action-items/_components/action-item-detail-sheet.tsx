        ...
        <div className="flex-1 space-y-5 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Select
                value={status}
                onValueChange={(v) => setStatus(v as ActionItem["status"])}
              >
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={priority}
                onValueChange={(v) => setPriority(v as ActionItem["priority"])}
              >
                <SelectTrigger className="h-9 text-sm">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {(
                    Object.entries(PRIORITY_LABEL) as [
                      ActionItem["priority"],
                      string,
                    ][]
                  ).map(([value, label]) => (
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This action cannot be undone. The action item will be
                  permanently removed.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
